...
Vale la pena señalar que CVE-2023-38606 es la tercera vulnerabilidad de seguridad descubierta en relación con la Operación Triangulación, una sofisticada campaña de ciberespionaje móvil dirigida a dispositivos iOS desde 2019 utilizando una cadena de explotación sin clic. Los otros dos, CVE-2023-32434 y CVE-2023-32435, fueron parcheados por Apple el mes pasado.
...
Con la última ronda de parches, Apple resolvió un total de 11 vulnerabildiades que afectaron su software desde principios de 2023. También se produce dos semanas después de que la compañía publicara soluciones de emergencia para un error explotado activamente en WebKit que podría conducir a la ejecución de código arbitrario (CVE-2023-37450).

### Recomendaciones

Adoptar una postura de ciberseguridad proactiva.
Realizar el parche de estas vulnerabilidades, actualizando el equipo en los canales oficiales.
Instalar endpoint o antivirus para dispositivos Apple IOS.

### Referencias

* Fuente 1: Apple lanza parches urgentes para fallas de día cero que afectan a iPhones, iPads y Macs
* Fuente 2: Apple Rolls Out Zero-Day Patches to Older iOS, macOS Devices
